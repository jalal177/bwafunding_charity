            ...
            <div class="xs-item-header">
              ...
              <div class="xs-skill-bar">
                <div class="xs-skill-track">
                  <p>
                    <span class="number-percentage-count number-percentage" data-value="90" data-animation-duration="3500">
              ...
              <div class="xs-item-content">
                ...
                <ul class="xs-list-with-content">
                  <li class="pladged">{formatCurrency(charity.pledged)}<span>Pledged</span></li>
                  <li><span class="number-percentage-count number-percentage" data-value="90" data-animation-duration="3500">{calculateFounded(charity.pledged, charity.target)}</span>% <span>Funded</span></li>
                ...
                <a href="/donation/{charity.id}" data-toggle="modal" data-target="#exampleModal" class="btn btn-primary btn-block"> Donate This Cause </a>
